      ...
      <div className="flex gap-4 mt-[1.5rem]">
        <div className="flex flex-col w-[17rem] h-[22.13rem] bg-darker-background border-border border-2 overflow-auto">
          {materials.map((material, index) => {
            ...
            return <MaterialBlock name={name} color={color} volume={volume} materialIndex={index} selectedMaterial={selectedMaterial} updateSelectedField={updateSelectedField} key={uuidv4()} />
          })}
        </div>
      </div>
    )
